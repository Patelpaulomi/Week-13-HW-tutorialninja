...
public class AccountLoginTest extends BaseTest {
    ...
    public void verifyUserShouldNavigateToLoginPageSuccessfully(){
        ...
        Assert.assertEquals(actualGetAccountLoginText, expectedGetAccountLoginText , "My Account page error");
        ...
        Assert.assertEquals(actualGetAccountLogoutText, expectedGetAccountLogoutText , "Logout was unsuccessful");
